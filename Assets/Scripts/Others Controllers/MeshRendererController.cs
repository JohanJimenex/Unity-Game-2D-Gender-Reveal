...
public class MeshRendererController : MonoBehaviour {
    ...
    [SerializeField] private Vector2 offsetVelocity = new Vector2(0, 0);
    ...
    private void MoveMainTextureOffset() {
        meshRenderer.material.mainTextureOffset += new Vector2(offsetVelocity.x, offsetVelocity.y) * Time.deltaTime;
